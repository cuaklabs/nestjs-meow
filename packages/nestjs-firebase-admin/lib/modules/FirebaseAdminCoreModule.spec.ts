  ...
  describe('.forRootAsync()', () => {
    describe('having a NestFirebaseAdminAppFactoryAsyncOptions', () => {
      ...
      describe('when called', () => {
        ...
        beforeAll(() => {
          (isNestFirebaseAdminAppFactoryAsyncOptions as unknown as jest.Mock<boolean>).mockReturnValueOnce(true);
    ...
    describe('having a NestFirebaseAdminAppClassAsyncOptions', () => {
      ...
      describe('when called', () => {
        ...
        beforeAll(() => {
          (isNestFirebaseAdminAppFactoryAsyncOptions as unknown as jest.Mock<boolean>).mockReturnValueOnce(false);
